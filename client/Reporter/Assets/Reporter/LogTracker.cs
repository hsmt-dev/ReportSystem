...
namespace Modules.Devkit.Diagnosis.LogTracker
{
    ...
    public sealed class UnityLogTracker
    {
        private static UnityLogTracker _instance;
        public static UnityLogTracker Instance 
        {
            get 
            { 
                return _instance ?? (_instance = new UnityLogTracker()); 
            }
        }
